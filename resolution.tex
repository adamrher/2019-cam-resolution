...
\end{center}
\caption{(a) Kinetic energy spectrum and (b) compensated kinetic energy spectrum at the 200 hPa level in the simulations. The diagonal black line in (a) is a reference spectrum with a $-3$ slope. Compensated kinetic energy spectrum refers to the kinetic energy spectrum multiplied by $n^{-\frac{5}{3}}$, with spherical wavenumber $n$, so that horizontal lines indicate a spectrum with a $-\frac{5}{3}$ slope. In (b), thick ``caterpillars" are overlain on the portion of each spectrum pertaining to the $5-10 \Delta x$ effective resolution of the model.}
\label{fig:2ke}
\end{figure}
