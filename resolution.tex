...
An experiment is carried out to unravel the contributions of warming and drying to the large spread in dilute CAPE between ascending/descending grid columns in the deep tropics. Through recomputing dilute CAPE using the mean specific humidity of ascending/descending regions, but setting the temperature profile to the mean profile for the entire deep tropics, one can isolate the contribution of changing moisture to the spread in dilute CAPE in the two regimes, and for each resolution. Doing the reverse then isolates the role of changing temperature profiles. Figure~\ref{fig:cape}c shows the influence of changing moisture on the dilute CAPE of subsiding/ascending regions in the deep tropics. To first order, the large spread in dilute CAPE between subsiding and ascending regions is due to the difference in moisture in subsiding and ascending regions, while temperature differences between the two regimes has a smaller, second order influence (not shown). The large spread in dilute CAPE between ascending/descending regions is crucial for maintaining the relationship in the deep tropics illustrated by the logistic regression, since the much smaller values of dilute CAPE of subsiding grid columns is required to depress dilute CAPE below the threshold for convection.
