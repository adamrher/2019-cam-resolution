...
\paperfield{Climate Modeling}
\corraddress{School of Marine and Atmospheric Sciences, Stony Brook University, Stony Brook, NY 11794, USA}
\corremail{\url{adam.herrington@stonybrook.edu}}
\presentadd{Climate and Global Dynamics Laboratory, National Center for Atmospheric Research, Boulder, CO, 80305, USA}
...
\runningauthor{Adam R. Herrington}
...
\begin{figure}
\begin{center}
\noindent\includegraphics[width=10pc,angle=0]{figs/temp_pdecomp.pdf}\\
\end{center}
